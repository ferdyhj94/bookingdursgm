    ...
    <div class="table-responsive table-bordered">
        <table class="table">
            ...
            <tbody>
                ...
                <tr>
                    <td colspan="6">
                        <center><strong>Kosong!</strong></center>
                    </td>
                </tr>
                <div class="modal fade" id="hapusObat" tabindex="-1" role="dialog" aria-labelledby="hapusModal"
                    ...
                    <div class="modal-dialog" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <p>Woohoo, You are readng this text in a modal! Use Bootstrap’s JavaScript modal plugin
                                    to add dialogs to your site for lightboxes, user notifications, or completely custom
                                    content.</p>
                            </div>
