                                ...
                                <div class="tab-content" id="pills-tabContent">
                                    ...
                                    <div class="tab-pane fade active show" id="pills-msg" role="tabpanel" aria-labelledby="pills-msg-tab">
                                        <div class="card">
                                            ...
                                            <div class="card-body">
                                                <form method="post" action="{{route('pengguna.submitSandi')}}">
                                                    {{csrf_field()}}
                                                    <div class="row">
                                                        <div class="offset-xl-3 col-xl-6 offset-lg-3 col-lg-3 col-md-12 col-sm-12 col-12 p-4">
                                                            <div class="form-group">
                                                                <label for="old password">Kata Sandi Terakhir</label>
                                                            ...
                                                            <div class="form-group">
                                                                <label for="retype new password">Ketik Ulang Kata Sandi Baru</label>
                                                                <input type="password" class="form-control form-control-lg" name="new_confirm_password" required>
                                                            </div>
